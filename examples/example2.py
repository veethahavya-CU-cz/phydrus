...
ml = ps.Model(
    exe_name=exe, ws_name=ws, name="model", description=desc, mass_units="-", time_unit="days", length_unit="cm"
)
...
m.loc[[1, 2]] = [[0.0001, 0.399, 0.0174, 1.3757, 29.75, 0.5], [0.01, 0.339, 0.0139, 1.6024, 405.34, 0.5]]
...
ml.add_root_growth(2, irfak=1, trmin=0, trmed=0, trmax=2143, xrmin=10, xrmed=0, xrmax=50, trperiod=365)
ml.write_input()
rs = ml.simulate()
